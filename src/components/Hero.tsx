  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-[300px] h-[300px] bg-white/5 rounded-full blur-[80px] animate-bounce duration-[10s]" />
      </div>
      ...
      >
        <motion.p
          ...
          className="text-sm md:text-base font-medium text-muted mb-6 tracking-widest uppercase"
        >
          Hello, I'm Yashpal
        </motion.p>
        <motion.h1
        ...
        <motion.p
          ...
          className="text-lg md:text-2xl font-light text-muted max-w-2xl mx-auto leading-relaxed"
        >
